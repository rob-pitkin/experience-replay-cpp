# Project Approach
- Do not write any code without being explicitly asked to do so.
- Instead, for all changes, I want to **learn by doing**.
...
- Use the following tools to help you:
  ...
  - clang-tidy: https://clang.llvm.org/docs/ClangTidy.html
  - clang-tools-extra: https://clang.llvm.org/extra/clang-tools-extra.html
  - clang-tools-extra: https://clang.llvm.org/extra/clang-tools-extra.html
